...
import CreateLeadTask from './createLeadTask/CreateLeadTask';
...
const LeadsPage = () => {
  ...
  const RowWithOptionsMenu = ({ row }) => {
    ...
    const handleEdit = (rowData) => {
      navigate(`/leads/edit/${rowData.id}`)
      handleMenuClose();
    };
    ...
    const handleCreateTask = () => {
     navigate(`/leads/createtask/${row.id}`)
    }
  ...
  const handleRowClick = (params) => {
    navigate(`/leads/profile/${params.row.id}`)
  }
      ...
      <div className="topbar">
        <div className="topbar-container">
          <div className="left">
            {
              selectedRows.length > 0 ? <div className="after-select-btn">
                <div className="left-btn">Create Macro</div>
                <div className="left-btn">Send Email</div>
                ...
                <select className="btn-option">
                  ...
                  <option value="">Add to Campaigns</option>
                  <option value="">Update Response</option>
                  <option value="">Print Mailing Labels</option>
                  <option value="">Mail Merge</option>
                  <option value="">Mass Convert</option>
            ...
            <div style={{ visibility: selectedRows.length > 0 ? 'hidden' : '' }} className="filter-btn"><FilterAltIcon /></div>

            <FormControl className='all-leads-btn' sx={{ display: selectedRows.length > 0 ? 'none' : '', m: 0, minWidth: 120, borderRadius: '5px' }} size="small">
              <InputLabel id="demo-select-small-label">All Leads</InputLabel>
              <Select
              ...
              >
                ...
                <MenuItem value='Recently Modified Leads'>Recently Modified Leads</MenuItem>
                <MenuItem value='Todays Leads'>Todays Leads</MenuItem>
          ...
          <div style={{ visibility: selectedRows.length > 0 ? 'hidden' : '' }} className="right">
            <Link to='/leads/create'><Button sx={{ fontWeight: 'bold', textTransform: 'none', padding: '8px 20px' }} variant="contained">Create Lead</Button></Link>
            ...
            <FormControl className='actions-btn' sx={{ m: 0, minWidth: 120, borderRadius: '5px' }} size="small">
              ...
              >
                ...
                <MenuItem value='Mass Convert'>Mass Convert</MenuItem>
                <MenuItem value='Manage Tags'>Manage Tags</MenuItem>
                <MenuItem value='Drafts'>Drafts</MenuItem>
                <MenuItem value='Mass Email'>Mass Email</MenuItem>
                <MenuItem value='Auto Responder'>Auto Responder</MenuItem>
                <MenuItem value='Approve Leads'>Approve Leads</MenuItem>
                <MenuItem value='Deduplicate Leads'>Deduplicate Leads</MenuItem>
                <MenuItem value='Add To Campaigns'>Add To Campaigns</MenuItem>
              </Select>
            </FormControl>
