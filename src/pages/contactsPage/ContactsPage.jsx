...
const ContactsPage = () => {
  ...
  const handleAllContactsChange = (event) => {
  ...
  const RowWithOptionsMenu = ({ row }) => {
    ...
    const handleCreateTask = () => {
      navigate(`/contacts/createtask/${row.id}`)
     }
  ...
  const handleRowClick = (params) => {
    navigate(`/contacts/profile/${params.row.id}`)
  }
        ...
        <div className="topbar-container">
          <div className="left">
            ...
            {!selectedRows.length > 0 && <FormControl className='all-contact-btn' sx={{ m: 0, minWidth: 140, borderRadius: '5px', }} size="small">
              <InputLabel id="demo-select-small-label">All Contacts</InputLabel>
              <Select
                labelId="demo-select-small-label"
                id="demo-select-small"
                value={contacts}
                label="All Contacts"
                onChange={handleAllContactsChange}
              >
                <MenuItem value="">
                  <em>None</em>
                </MenuItem>
          ...
          <div style={{ visibility: selectedRows.length > 0 ? 'hidden' : '' }} className="right">
            <Link to='/contacts/create'>
              <Button sx={{ fontWeight: 'bold', textTransform: 'none', padding: '8px 20px' }} variant="contained">Create Contact</Button>
            </Link>
            ...
            <FormControl className='actions-btn' sx={{ m: 0, minWidth: 120, borderRadius: '5px' }} size="small">
              ...
              >
                ...
                <MenuItem value='Approve-Contacts'>Approve Contacts</MenuItem>
